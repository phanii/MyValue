package com.myprice.value.ui.chat
 ...
 * [ChatScreen.OnFragmentInteractionListener] interface
...
class ChatScreen : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        val productBean: ProductBean? = arguments?.getParcelable("product")

        chat_product_quantity.text = productBean?.quantity
        chat_send_button.setOnClickListener {
            sendMyMessageNow(chat_editText.text.toString())
        }
    }

    private fun sendMyMessageNow(toString: String) {
        showToast(requireContext(), toString)
    }
