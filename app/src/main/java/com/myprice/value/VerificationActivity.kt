...
class VerificationActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onStart() {
        ...
        if (verificationInProgress && validatePhoneNumber()) {
            startPhoneNumberVerification(fieldPhoneNumber.tag.toString().plus(fieldPhoneNumber.text.toString()))
        }
        // [END_EXCLUDE]
    }
    ...
    private fun updateUI(
        ...
        if (user == null) {
            ...
            detail.text = getString(R.string.firebase_status_fmt, user.phoneNumber)
    ...
    private fun validatePhoneNumber(): Boolean {
        val phoneNumber = fieldPhoneNumber.tag.toString().plus(fieldPhoneNumber.text.toString())
    ...
    override fun onClick(view: View) {
        when (view.id) {
            ...
            R.id.buttonResend -> resendVerificationCode(
                fieldPhoneNumber.tag.toString().plus(fieldPhoneNumber.text.toString()),
                resendToken
            )
